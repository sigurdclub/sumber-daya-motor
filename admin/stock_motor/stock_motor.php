...
<div class="container-fluid">
    ...
    <div class="">
        <h1 class="m-0" style="text-align: center; color: black;"> Stock Motor </h1>
    </div>
...
<!-- Isi konten -->
    <div class="container-fluid">
        ...
        <div style="display: flex; justify-content: right; margin-top: 2%;">
            ...
            <div>
                <a href="./tambah.php">
                    <button type="button" class="btn btn-primary">Tambah Motor</button>
                </a>
        ...
        <table class="table-admin table table-hover" >
            ...
            <tbody style="background-color: #D9CAB3;">
                    ...
                    <tr>
                        ...
                        <td><?php echo $baris['merek_motor'];?></</td>
                        <td><?php echo $baris['tipe'];?></td>
                        <td><?php echo $baris['stok'];?></td>
                        <td><?php echo $baris['satuan'];?></td>
                        <td><img src="../foto/<?php echo $baris['gambar'];?>" width="100px"></td>
                        <td style="display: flex; justify-content: space-around;">
                            <a href="./edit.php?id=<?php echo $baris["id_motor"];?>">
                                <button type="button" class="btn btn-warning">Edit</button>
                            </a>
                            <a href="./hapus.php?id=<?php echo $baris["id_motor"];?>">
