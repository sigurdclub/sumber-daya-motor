...
<div class="content-wrapper" style="background-color: #D9CAB3;">
    ...
    <div class="container-fluid">
        ...
        <div class="">
            <h1 class="m-0" style="text-align: center; color: black;">Tambah Stok Motor</h1>
        </div>
...
<div class="card card-stock-barang" style="width: 50%; background-color: #D9CAB3;">
    ...
    <form class="row g-3" action="" method="POST" enctype="multipart/form-data">
        ...
        <div class="col-12">
            <label for="inputAddress2" class="form-label">Merek Motor</label>
            <input type="text" class="form-control" id="inputAddress4" placeholder="..." name="merek" required style="background-color: white;">
        </div>
        <div class="col-12">
            <label for="inputAddress2" class="form-label">Tipe</label>
            <input type="text" class="form-control" id="inputAddress4" placeholder="..." name="tipe" required style="background-color: white;">
        </div>
        <div class="col-12">
            <label for="inputAddress2" class="form-label">Stok</label>
            <input type="text" class="form-control" id="inputAddress3" placeholder="..." name="stok" required style="background-color: white;">
        </div>
        <div class="col-12">
        ...
        <div class="col-12">
            ...
            <input type="file" class="form-control" id="inputAddress3" placeholder="..." name="gambar" required style="background-color: white;">
        </div>
