...
<div class="content-wrapper" style="background-color: #D9CAB3;">
    ...
    <div class="container-fluid">
        ...
        <div class="">
            <h1 class="m-0" style="text-align: center; color: black;">Tambah Motor Masuk</h1>
        </div>
    ...
    <div class="card-body">
        <form class="row g-3" action="" method="POST" enctype="multipart/form-data">
            <div class="form-group">
                <label>Select</label>
                <select class="form-control" name="merek_motor" required style="background-color: white; color: black;">
                    <option>--Pilih Barang--</option>
                    <?php
                        $data = query("SELECT * FROM stok_motor");
                    ?>
                    <?php foreach($data AS $row): 
                        $namabarang = $row['merek_motor'];
                        $idmotor = $row['id_motor'];
                    ?>
                    <option value="<?php echo $idmotor;?>"><?php echo $namabarang;?></option>
                    <?php endforeach;?>
                </select>
            </div>
            <div class="col-12">
            ...
            <div class="col-12">
                ...
                <input type="text" class="form-control" id="inputAddress4" placeholder="..." name="jlh" required style="background-color: white;">
            </div>
            <div class="col-12">
                <label for="inputAddress2" class="form-label">Penerima</label>
                <input type="text" class="form-control" id="inputAddress3" placeholder="..." name="penerima" required style="background-color: white;">
            </div>
